...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    Therefore, $\mathcal{L}$ admits strict filtrations since $\mathcal{M}_{\mathcal{L}}^{\varphi}$ is already finite. In particular, ${\bf K}5$ fails to have the finite ``canonical'' model property that follows from the contraposition of this statement and Theorem~\ref{sad}.
